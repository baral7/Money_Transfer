...
namespace MoneyTransfer.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public TransactionsController(TransferOfficialContext context)
        {
            _context = context;
        }
        ...
        {
            var transferOfficialContext = _context.Transactions.Include(t => t.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TransferOfficialContext.Transactions'  is null.");
            }
            var transaction = await _context.Transactions.FindAsync(id);
            if (transaction != null)
            {
