...
namespace MoneyTransfer.Controllers
{
    public class BankDetailsController : Controller
    {
        ...
        public BankDetailsController(TransferOfficialContext context)
        {
            _context = context;
        }
        ...
        {
            var transferOfficialContext = _context.BankDetails.Include(b => b.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,AccountNumber,AccountName,Address,AmountIn,AmountOut,TransactionLimit,UserId")] BankDetail bankDetail)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "Id", bankDetail.UserId);
            return View(bankDetail);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TransferOfficialContext.BankDetails'  is null.");
            }
            var bankDetail = await _context.BankDetails.FindAsync(id);
            if (bankDetail != null)
            {
